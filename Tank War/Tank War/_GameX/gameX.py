...
print("Welcome to _GameX, a product developed using Pygame!")
...
class Role(pygame.sprite.Sprite):
    ...
    def goto(self, xy_position: tuple[int, int]):
        self.position = Position(*xy_position)
...
def help(cont=None):
    ...
    - set_window(size=(800, 600), title="_GameX!"):
        初始化Pygame和游戏窗口。
        参数：
            size: 窗口尺寸元组(width, height)，默认(800, 600)
            title: 窗口标题字符串，默认"_GameX!"
